...
export default class Item extends React.Component {
  ...
  renderAnnotations() {
    ...
    return <Annotations data={omit(detail.annotations, ['displayName', 'desc', 'creator'])} />;
  }
      ...
      <Panel>
        <div className={styles.header}>
          <div className={styles.cluster}>
            <ClusterTitle cluster={cluster} theme="light" tagClass="float-right" />
          </div>
          ...
          {gateway.type === 'NodePort' ? (
            ...
            <Text title={this.getExternalIP(gateway)} description={t('EXTERNAL_IP_ADDRESS')} />
          )}
        </div>
