        ...
        <div className={styles.content}>
          <div className={styles.contentItem}>
            ...
            <div className={styles.item}>
              <div>{cpuRequest ? `${cpuRequest} Core` : t('NO_REQUEST_TCAP')}</div>
          ...
          <div className={styles.contentItem}>
            ...
            <div className={styles.item}>
              <div>{memoryRequest ? `${memoryRequest} Mi` : t('NO_REQUEST_TCAP')}</div>
              <p>{t('MEMORY_REQUEST_SCAP')}</p>
            </div>
            <div className={styles.item}>
              <div>{memoryLimit ? `${memoryLimit} Mi` : t('NO_LIMIT_TCAP')}</div>
