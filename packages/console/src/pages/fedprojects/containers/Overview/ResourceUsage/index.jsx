...
import { Loading, RadioButton, RadioGroup, Select } from '@kube-design/components';
...
const PHYSICAL_RESOURCE_METRIC_TYPES = ['namespace_cpu_usage', 'namespace_memory_usage_wo_cache'];
...
class ResourceUsage extends React.Component {
  ...
  renderPhysicalResource() {
    ...
    const range = this.timeOptions.find(item => item.value === this.state.range) || {};
    ...
    return (
      <div className={styles.header}>
        <RadioGroup
          ...
          size="small"
        >
          <RadioButton value="application">{t('APPLICATION_RESOURCE_PL')}</RadioButton>
          <RadioButton value="physical">{t('PHYSICAL_RESOURCE_PL')}</RadioButton>
        </RadioGroup>
