...
export default class ClusterService extends Component {
  ...
  get isStateless() {
    return (
      get(this.props.store.detail, 'annotations["kubesphere.io/serviceType"]') ===
      'statelessservice'
    );
  }
    ...
    return (
      <Panel>
        <div className={styles.header}>
          ...
          />
          <Text title={detail.clusterIP} description={t('VIRTUAL_IP_ADDRESS')} />
          <MoreActions className={styles.more} options={this.getEnabledOperations()} />
        </div>
