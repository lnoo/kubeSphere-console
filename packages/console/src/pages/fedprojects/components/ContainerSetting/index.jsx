...
import { Form, Alert, Input, Select, Columns, Column } from '@kube-design/components';
        ...
        <>
          <Columns className={styles.columns}>
            <Column>
              ...
              >
                <Input name="name" defaultValue={`container-${generateId()}`} maxLength={63} />
              </Form.Item>
            </Column>
            <Column>
          ...
          <Alert className="margin-b12" type="info" message={t('CONTAINER_RESOURCE_LIMIT_TIP')} />
          <Form.Item rules={[{ validator: this.limitValidator, checkOnSubmit: true }]}>
            <ResourceLimit
              name="resources"
