...
class RouteRulesEdit extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (!isEqual(toJS(this.props.detail._originData), toJS(prevProps.detail._originData))) {
      this.setState({
  ...
  render() {
    const { visible, cluster, isSubmitting, isFederated, projectDetail } = this.props;
